...
%% 0) Load & normalize
inFile = "transfer_raw_matlab.csv";
...
%% 5) Export
writetable(roiMeans, "matlab_roi_means.csv");
writetable(fitLong,  "matlab_fit_table_long.csv");
writetable(curvePred,"matlab_curve_predictions.csv");
